...
export const ActionNamesMap: AnyObject = {
  ...
  [EXPORT_COMMENTS_EPD]: {text: translate('EXPORT_EGDD_COMMENTS'), textKey: 'EXPORT_EGDD_COMMENTS'},
  [EXPORT_PDF_EPD]: {text: translate('EXPORT_EGDD_PDF'), textKey: 'EXPORT_EGDD_PDF'},
  [EXPORT_XLS_EPD]: {text: translate('EXPORT_EGDD_XLS'), textKey: 'EXPORT_EGDD_XLS'},
  [EXPORT_RESULTS_EPD]: {text: translate('EXPORT_EGDD_RESULTS'), textKey: 'EXPORT_EGDD_RESULTS'},
